              ...
              <?php 
                foreach ( $header_menus as $menu_items ) {
                  if ( ! $menu_items->menu_item_parent ) {
                    $child_menu_items = $menu_class->get_child_menu_items( $header_menus, $menu_items->ID );
                    // echo "<pre>";
                    ...
                    if ( ! $has_children ) {
                      ?>
                      <li class="nav-item">
                        <a class="nav-link" href="<?php echo esc_url( $menu_items->url ); ?>">
                          <?php echo esc_html( $menu_items->title ); ?>
                        </a>
                      </li>
                      <?php
                    } else {
